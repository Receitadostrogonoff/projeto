#    versão 2 da nosso codigo e da nossa base de dados - 16/10/2023
#    o que foi alterado?
...
#1- nao sera criado um grafico de dispersão devido ao fato de que sera utilizado uma serie.
#2- criação dos ultimos graficos e aperfeiçoementodo outros que ja existem.
...
#versao 9 - versao final parte 4 - 28/11/2023
#1 - criação 
#2 - criação de um mapa para a população total 
...
ggplot(data = minha_tabela2, mapping = aes(x = tipo_regiao, y=..prop.., fill = tipo_regiao)) + 
  ...
  scale_fill_manual(values = c("belo horizonte" = "#FF61c9",
                               "Interior de Minas Gerais" = "#d7008d",
...
mapa1 = ggplot() + 
  ...
  scale_fill_distiller(palette = "RdPu", direction = 1, name="Total de vítimas",
                       limits = c(1,40))+
  labs(title = "Total de ocorrências de feminicídio em MG",caption = "Área cinza não possui informação.")
...
mapa2 = ggplot() + 
  ...
  scale_fill_distiller(palette = "RdPu", direction = 1, name="Total de vítimas",
                       limits = c(1,40))+
  labs(title = "Total de ocorrências de tentativas de feminicídio em MG",caption = "Área cinza não possui informação.")

mapa2


#___________________________________________
#mapa 3 - total de vítimas consumadas
...
mapa3 = ggplot() + 
  ...
  scale_fill_distiller(palette = "RdPu", direction = 1, name="Total de vítimas",
                       limits = c(1,40))+
  labs(title = "Total de ocorrências de feminicídios consumados em MG",caption = "Área cinza não possui informação.")
...
# mapa do consumado por 100mil habitantes
